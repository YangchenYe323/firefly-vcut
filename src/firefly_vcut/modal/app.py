...
app = modal.App("firefly-vcut", image=image)

cache_volume = modal.Volume.from_name("firefly-vcut-cache", create_if_missing=True)

bucket_volume = modal.CloudBucketMount(
    bucket_name="firefly-bilibili",
    bucket_endpoint_url="https://4cb286975eef682e084aed1ca7819282.r2.cloudflarestorage.com",
    secret=secret,
    read_only=False,
)
...
def transcript_key_from_recording(recording: dict) -> str:
    ...
    return f"transcripts/{mid}/{year}/{month}/{day}/{bvid}.json"
